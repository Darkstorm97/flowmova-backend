...
public class GetPublicLocationAccessService {
    ...
    public GetPublicLocationAccessService(ServiceUnitLocationRepository serviceUnitLocationRepository) {
    ...
    public PublicLocationAccessResponse get(String publicAccessSlug) {
        ...
        return PublicLocationAccessResponse.from(company, serviceUnit, location);
    }
}
